...
const Tips = () => {
  return (
    ...
    <div className="left-[60px] relative w-full h-[832px] overflow-hidden text-left text-base text-black font-inter">
      ...
      {/* <img
        ...
        src="/below-1.svg"
      /> */}
      <div className="absolute z-50 top-[719px] left-[530px] bg-[#FFD6Ff] rounded-full p-4">
      <a href="/tips/adolescent">Click to view More</a>
      </div>
      <div className="absolute z-50 top-[627px] left-[489px] font-light text-center inline-block w-[249px]">
        Navigating Adolescence: A Guide to Thriving Through the Teenage Years
      </div>
      <img
        className="absolute z-50 top-[447px] left-[510px] w-[211px] h-[158px] object-cover"
        alt="img3"
        src="/images/adolescent.png"
      />
      <div className="absolute z-50 top-[405px] left-[510px] text-7xl font-medium inline-block w-[229px] h-[31px]">
      ...
      <img
        className="absolute top-[453px] left-[886px] w-[211px] h-[158px] object-cover"
        alt="img4"
        src="/images/wash.png"
      />
